...
class GoogleAnalyticsBuilder implements OrderRequestBuilderInterface
{
    ...
    public function build(
        ...
        $googleAnalyticsId = Configuration::get('MULTISAFEPAY_OFFICIAL_GOOGLE_ANALYTICS_ID');
        if (empty($googleAnalyticsId)) {
            return;
        }

        $orderRequest->addGoogleAnalytics((new GoogleAnalytics())->addAccountId($googleAnalyticsId));
    }
}
